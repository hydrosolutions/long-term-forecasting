...
class TestHistoricalMetaLearnerSimple:
    ...
    def test_model_save_load(self, meta_learner):
        ...
        save_dir = os.path.join(meta_learner.path_config["model_home_path"], meta_learner.name)
...
def main():
    ...
    try:
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            meta_learner = test_instance.meta_learner(sample_data, sample_static_data, sample_configs)
        ...
        logger.info("✓ All HistoricalMetaLearner simplified functionality tests passed!")
