...
class TestHistoricalMetaLearner:
    ...
    def _create_multiyear_predictions(self):
        ...
        for i, model_name in enumerate(['XGB', 'LGBM', 'CatBoost']):
            ...
            obs = 50 + seasonal_pattern + np.random.randn(365*3) * 5
            pred = obs + np.random.randn(365*3) * (1 + i * 0.5)  # Different noise levels
    ...
    def test_calculate_historical_performance(self):
        ...
        for model_id, perf_data in performance.items():
            ...
            assert 'BASIN01' in basin_metrics
            assert 'BASIN02' in basin_metrics
    ...
    def test_compute_performance_weights(self):
        ...
        weights = meta_learner.compute_performance_weights(performance_data, metric='rmse')
    ...
    def test_compute_basin_specific_weights(self):
        ...
        basin_weights = meta_learner.compute_basin_specific_weights('BASIN01')
    ...
    def test_compute_weights_combined(self):
        ...
        combined_weights = meta_learner.compute_weights(basin_code='BASIN01', month=1)
