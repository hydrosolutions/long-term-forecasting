...
from monthly_forecasting.scr.evaluation_utils import (
    r2_score, rmse, mae, nse, kge, bias, nrmse, mape, pbias,
    calculate_all_metrics, evaluate_predictions
)
...
class TestEvaluationUtils:
    ...
    def test_calculate_all_metrics(self):
        ...
        expected_metrics = ['r2', 'rmse', 'nrmse', 'mae', 'mape', 'nse', 'kge', 'bias', 'pbias']
    ...
    def test_evaluate_predictions_grouped(self):
        ...
        test_df = pd.DataFrame({
            ...
            'date': pd.date_range('2020-01-01', periods=2*self.n_samples, freq='D'),
