...
class UncertaintyNet(nn.Module):
    ...
    def forward(self, batch):
        ...
        base_learner_errors = batch[
            "base_learner_errors"
        ]  # (B, base_learner_error_dim)
        ...
        base_learners_c = torch.cat(
            [base_learners, base_learner_errors], dim=1
        )  # (B, lookback+future_known_steps, base_learner_dim)
