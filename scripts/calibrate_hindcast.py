...
def load_data(data_config: Dict[str, Any], path_config: Dict[str, Any]) -> tuple:
    ...
    hydro_ca, static_df = dl.load_data(
        ...
        path_to_operational_forcing=path_config.get(
            "path_to_operational_forcing", None
        ),
        HRU_forcing=path_config.get("HRU_forcing", None),
        path_to_hindcast_forcing=path_config.get("path_to_hindcast_forcing", None),
    )
